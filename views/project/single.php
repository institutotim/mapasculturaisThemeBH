...
//regra avaliador : Ricardo 20/02/2018
$isEdit = false;
$proj = array(116,117,118,135,136,137,245,249,250,251,261,264,409);
if(!(in_array($entity->id, $proj)) || $app->user->is('superAdmin') || $app->user->is('admin')){
  $isEdit = true;	
}
...
if( !$this->isEditable() || ( $this->isEditable() && $isEdit  )){
?>
...
<?php }else{
	...
	echo "Você não pode editar este projeto.";
}?>
