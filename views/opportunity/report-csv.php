...
<table>
    <thead>
        <tr>
            ...
            <?php /*
			foreach($space_properties as $prop): ?>
        ...
        <?php foreach($entity->sentRegistrations as $r): ?>
            <tr>
                ...
                foreach($custom_fields as $field):
                    ...
                    echo "<th>";
					//verificar o ID da oportunidade
					$OpportunityID = basename($_SERVER['REQUEST_URI']);
					if($OpportunityID == 587):
						if(!is_null($_field_val) || $_field_val != "") :
							if(is_array($_field_val)) :
								foreach($_field_val as $campos):
									if(is_object($campos)):
										echo $campos->title." - ".$campos->value."<br>";
									else:
										echo $campos;
									endif;
								endforeach;
                ...
                <td>
                 ...
                 <?php /*
				 foreach($r->getSpaceData() as $field): 
